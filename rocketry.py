...
plt.axis((0,2.5,0,8))
plt.ylabel("Height")
plt.plot(time,altitude, "k", label = "Altitude")
plt.plot(max_time, max_height, "go", label = "Max Height")
plt.legend(loc="lower right")

plt.subplot(212)
plt.ylabel("Velocity")
plt.xlabel("Time")
plt.plot(time[:-1], velocity, "r", label = "Velocity")
plt.plot(time[:-1], filtered, "b", label = "Filtered Velocity")
plt.legend(loc="lower right")
plt.show()